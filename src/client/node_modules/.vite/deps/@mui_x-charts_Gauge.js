...
import "./chunk-754CCMWI.js";
import "./chunk-BPTAPQKP.js";
import {
  clsx_default,
  composeClasses,
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React5.useState(typeof window !== "undefined" || false);
  React5.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function ChartsText(props) {
  ...
  const wordsByLines = React6.useMemo(() => getWordsByLines({
    style,
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime6.jsx)("g", {
    ...
    children: (0, import_jsx_runtime6.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
var _excluded6 = ["text", "children", "classes", "className", "skipAnimation"];
...
var Gauge = React7.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className,
  ...
  return (0, import_jsx_runtime7.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime7.jsx)(GaugeReferenceArc, {}), (0, import_jsx_runtime7.jsx)(GaugeValueArc, {
      skipAnimation
    }), (0, import_jsx_runtime7.jsx)(GaugeValueText, {
      text
    }), children]
  }));
});
